...
LD_LIBRARY_PATH := $ROOTSYS/lib/home/hep/dsg12/TMVA-v4.2.0/
...
LDFLAGS := $(inherited) `root-config --libs --glibs  --cflags`-L$(TMVASYS)/lib -lTMVA -lMLP -lMinuit -lXMLIO -lTreePlayer 
