...
//Top
const char* top_arr[] = {"data/background/MC_T-tW.root", "data/background/MC_Tbar-tW.root"};
...
//Z+jets->vv
//"~/mproject/data/background/MC_VBF_HToZZTo4Nu_M-200.root" - don't know if this is z+jets
...
const char* mc_signal_data_arr[] = {"data/signal/MC_Powheg-ggHtoinv-mH125.root", "data/signal/MC_Powheg-Htoinv-mH125.root"};
...
const char* varsss[][6] = {
                              ...
                              {"met_x", "-400.0", "400.0", "left", "370.0", "400.0"},
