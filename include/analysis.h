...
const char* vars[][5] = {
                              ...
                              {"jet1_eta", "-5.0", "5.0",  
                               "0.6", "1.0"},
                              {"forward_tag_eta", "-5.0", "5.0",  
                               "4.1", "4.3"},
                              {"dijet_deta", "3.0", "8.0",  
                               "6.4", "6.7"},
                              {"dijet_sumeta", "-6.0", "6.0",  
                               "3.5", "4.0"},
                              {"dijet_dphi", "0.0", "4.0",  
                               "1.3", "1.5"},
                              {"met", "0.0", "400.0",  
                              ...
                              {"metnomu_x", "-400.0", "400.0", 
                                "340.0", "400.0"},
                              {"metnomu_y", "-400.0", "400.0",  
                               "200.0", "400.0"},
                              {"met_significance", "0.0", "12.0",  
                               "7.2", "10.0"},
                              {"metnomu_significance", "2.0", "12.0",  
                               "6.8", "10.2"},
                              {"sumet", "0.0", "2400.0",  
                               "1900.0", "2400.0"},
                              {"ht", "0.0", "1200.0",  
                              ...
                              {"sqrt_ht", "0.0", "35.0",  
                               "10.0", "13.0"},
                              {"unclustered_et", "0.0", "2000.0",  
                               "1400.0", "1600.0"},
                              {"jet1met_dphi", "0.0", "3.5",  
                               "2.1", "2.4"},
                              {"jet2met_dphi", "0.0", "3.5",  
                               "1.4", "1.7"},
                              {"jet1metnomu_dphi", "0.0", "3.5",  
                               "2.1", "2.5"},
                              {"jet2metnomu_dphi", "0.0", "3.5",  
                               "1.4", "1.7"},
                              {"jetmetnomu_mindphi", "0.0", "3.5",  
                               "2.9", "3.1"},
                              {"alljetsmet_mindphi", "0", "3.2",  
                               "2.2", "3.0"},
                              {"alljetsmetnomu_mindphi", "0.0", "3.5",  
                               "2.2", "3.0"},
                              {"jetunclet_mindphi", "0.0", "3.5",  
                               "2.8", "2.9"},
                              {"metnomuunclet_dphi", "0.0", "3.5",  
                               "2.8", "2.9"},
                              {"dijetmet_scalarSum_pt", "0.0", "1200.0",  
                               "800.0", "900.0"},
                              {"dijetmet_vectorialSum_pt", "0.0", "400.0",  
                               "240.0", "250.0"},
                              {"dijetmet_ptfraction", "0.0", "1.0",  
                               "0.76", "0.82"},
                              {"jet2met_scalarprod", "-400.0", "400.0",  
                               "20.0", "50.0"},
                              {"dijetmetnomu_scalarSum_pt", "0.0", "1200.0",  
                               "800.0", "950.0"},
                              {"jet2metnomu_scalarprod", "-2000.0", "2000.0",  
                               "400.0", "500.0"},
                              {"l1met", "0.0", "400.0",  
                               "250.0", "400.0"},
                              {"metnomuons", "0.0", "400.0",  
                               "320.0", "400.0"},  
                              {"mht", "0.0", "3000.0",  
                               "2400.0", "2800.0"},
                              {"nvetomuons", "0.0", "3.0",  
                               "0.9", "1.1"},
                              {"nvetoelectrons", "0.0", "3.0",  
                               "0.9", "1.1"},
                              {"met_x", "-400.0", "400.0",  
                               "370.0", "400.0"},
                              {"met_y", "-400.0", "400.0",  
