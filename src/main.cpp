...
void produce_graphs() {
	...
	Variable* ht = new Variable("ht", "HCAL Scalar Sum of Energy","0.0", "1200.0","75.0", "175.0","60","70");
	Variable* ht30 = new Variable("ht30","HCAL Scalar Sum of Energy over 30GeV", "0.0", "1200.0","50.0", "140.0","75","70");
	...
	Variable* jet1metnomu_scalarprod = new Variable("jet1metnomu_scalarprod","(Jet-1,MET); Scalar Product Excluding Muons", "-2000.0", "2000.0","-2000.0", "-400.0","90","40");
