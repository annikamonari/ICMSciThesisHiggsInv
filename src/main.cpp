...
"MLP", NTrees[0], BoostType[0],AdaBoostBeta[0], SeparationType[0], nCuts[0], NeuronType[0], NCycles[0], HiddenLayers[0],mva_cut_str);*/
...
for (int i = 0; i < 1/*bg_chains.size()*/; i++)
  ...
  MVAAnalysis::get_plots_varying_params(bg_chains, relevant_bgs[i], signal_chain, data_chain, super_vars,
                                     mva_type1, varying_param1, NTrees, BoostType,AdaBoostBeta, SeparationType,
